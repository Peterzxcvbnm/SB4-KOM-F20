...
public class Game
    ...
    @Autowired
    public Game(List<IEntityProcessingService> entityProcessors, List<IPostEntityProcessingService> postEntityProcessors, List<IGamePluginService> entityPlugins) {
